...
<Box>
  ...
  <p>The one thing test shouldn't test is your patience</p>
</Box>
...
## Integration test
Today's focus, for frontend. Tests interaction and how the components work together. Mocks frontend
server responses

## End to end test
Does not mock the server response
...
### Can begin frontend development before api completed when given contract
...
### No guarantee your mocked responses match the actual data the server sends
...
- Mix and match, typically have one true end-to-end test, and then mock the rest
...
## Know when to mock and not to mock
